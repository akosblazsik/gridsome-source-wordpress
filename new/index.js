...
class WordPressSource {
  ...
  constructor(api, options) {
    console.log(`### WordPressSource Plugin `)
    ...
    api.loadSource(async actions => {
      ...
      console.log("---")
      console.log(`#### Get custom endpoints`)
    ...
    for (const type in this.restBases.posts) {
      ...
      for (const post of data) {
        ...
        if (post.type !== TYPE_ATTACHEMENT) {
          ...
          console.log("- featured media: " + fields.featuredMedia);
          console.log("  - id: " + fields.featuredMedia.id);
